...
static const char *name				= "TR20x module, v1.0";

static const char *terminal_name	= "TR203, TR206";
static const int   terminal_type	= OBJECT_TYPE;

static std::string host				= "*";
static std::string port				= "4592";
...
int set_var(int var_type, void *p)
{
	...
	case MODULE_VAR_OPTION:
		...
		if (strcmp(op->name, "port") == 0) {
			...
			api_log_printf("[TR20x] Warning: unknown config option '%s'\r\n", op->name);
		}
		break;
