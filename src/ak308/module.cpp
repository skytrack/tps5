...
static const char *name				= "AK386 module, v1.0";

static const char *terminal_name	= "AK308";
...
int start()
{
	...
	if (id == NULL) {
		api_log_printf("[AK308] Unable to allocate id buffer\r\n");
